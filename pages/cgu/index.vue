<template>
    <div id="cgu" class="my-5">
        <div class="container">
            <h2 class="title is-2">Conditions générales d'utilisation</h2>    
            ...
            <article class="text-justify">
                ...
                <br><span class="society">{{society}}</span> se réserve le droit de les corriger, dès que ces erreurs sont portées à sa connaissance. 
                <br>Il est fortement recommandé de vérifier l’exactitude et la pertinence des informations et/ou documents mis à disposition sur ce site. 
                <br>Les informations et/ou documents disponibles sur ce site sont susceptibles d’être modifiés à tout moment, et peuvent avoir fait l’objet de mises à jour. En particulier, ils peuvent avoir fait l’objet d’une mise à jour entre le moment de leur téléchargement et celui où l’utilisateur en prend connaissance. 
                <br>L’utilisation des informations et/ou documents disponibles sur ce site se fait sous l’entière et seule responsabilité de l’utilisateur, qui assume la totalité des conséquences pouvant en découler, sans que <span class="society">{{society}}</span> puisse être recherché à ce titre, et sans recours contre ce dernier. 
                <br><span class="society">{{society}}</span> ne pourra en aucun cas être tenu responsable de tout dommage de quelque nature qu’il soit résultant de l’interprétation ou de l’utilisation des informations et/ou documents disponibles sur ce site. </p>
                <p></p>
            </article>
            ...
            <article class="text-justify">
                <p>Les informations recueillies (numéros de téléphone et adresses mail) font l’objet d’un traitement informatique destiné à la gestion de la clientèle. Ces informations ne seront pas utilisées à but commercial. Le destinataire des données est l’association <span class="society">{{society}}</span>  et les entreprises inscrites sur le site. 
                <br>Conformément à la loi « informatique et libertés » du 6 janvier 1978 modifiée en 2004, vous bénéficiez d’un droit d’accès et de rectification aux informations qui vous concernent, que vous pouvez exercer en vous adressant à <span class="email">{{email}}</span>. 
                <br>Vous pouvez également, pour des motifs légitimes, vous opposer au traitement des données vous concernant.</p>
                <p></p>
            </article>
            ...
            <article class="text-justify">
                ...
                <br>Pour toute question relative aux présentes conditions d’utilisation du site, vous pouvez nous écrire à l’adresse suivante : </p>
                <ul>
                    <li>Association <span class="society">{{society}}</span>  </li>
                    <li>218 rue Saint-Denis  </li>
                    <li>75002 Paris </li>
                </ul>
            </article>
            <article class="text-justify">
                <p><a href="http://www.droitissimo.com">Droitissimo.com</a> est titulaire des droits d’auteurs du modèle des CGU ci-dessus : 
                <br>
                <a href="http://www.droitissimo.com/contrat/conditions-generales-dutilisation-cgu-dun-site-internet">http://www.droitissimo.com/contrat/conditions-generales-dutilisation-cgu-dun-site-internet</a>
                </p>
            </article>
